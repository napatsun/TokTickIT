...
| API-30 | API | AC-12, BR-29 (dup of BR? see BR-29 dup) | Create/edit user with duplicate email | 422 field-level error, no user created/mutated | `server/tests/lab-03/users-admin.api.test.ts` | Pending |
